...
const buildDiffTree = (obj1, obj2 = obj1) => {
  ...
  const result = keys.reduce((acc, key) => {
    ...
    if (value1 === undefined) {
      const parsedValue2 = _.isObject(value2) && !_.isArray(value2) ? buildDiffTree(value2) : value2;
      acc.push({ key, value: parsedValue2, status: '+' });
    } else if (value2 === undefined) {
      const parsedValue1 = _.isObject(value1) && !_.isArray(value1) ? buildDiffTree(value1) : value1;
